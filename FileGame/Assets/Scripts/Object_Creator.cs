...
public class Object_Creator : MonoBehaviour {
    ...
    void Start () {
        ...
        int points_to_use = PlayerPrefs.GetInt("generation_points",10);           // how many file extensions we want to generate, will increase as game proceed
        ...
        int text_files_count = PlayerPrefs.GetInt("text_files_count", 4);
        int image_files_count = PlayerPrefs.GetInt("image_files_count", 3);
        int video_files_count = PlayerPrefs.GetInt("video_files_count", 3);
